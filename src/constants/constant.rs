...
pub const IPFS_4EVER_DEDICATED: &str = "https:://42683ff2b1a2ac5ad2fef0ee01995d78.ipfs.4everland.link/ipfs";
...
pub const DEFAULT_IPFS_FETCH_PROVIDER: IPFSFetchProvider = IPFSFetchProvider {
    kind: IPFSFetchProviderKind::ForEverDedicated,
    address: IPFS_4EVER_DEDICATED,
};
